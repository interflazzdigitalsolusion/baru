...
def get_group_members(
    ...
    spinner("Fetching group members...")
    res = send_api_request(api_key, path, raw_payload, tokens["id_token"], "POST")
    return res
...
def remove_circle_member(
    ...
    spinner(f"Removing member {member_id} from Circle...")
    res = send_api_request(api_key, path, raw_payload, tokens["id_token"], "POST")
    return res
...
def accept_circle_invitation(
    ...
    spinner(f"Accepting invitation to Circle {group_id}...")
    res = send_api_request(api_key, path, raw_payload, tokens["id_token"], "POST")
    return res