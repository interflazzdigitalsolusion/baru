...
def get_otp(contact: str) -> str:
    ...
    try:  
        ...
        # Nonaktifkan tampilan JSON response
...
def get_profile(api_key: str, access_token: str, id_token: str) -> dict:
    ...
    def spinner(text="Fetching profile..."):
        anim = ["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"]
        for i in range(20):
    ...
    # 🔁 Ganti print dengan loader
    spinner("Fetching profile...")
...
def get_balance(api_key: str, id_token: str) -> dict:
    ...
    # 🔄 Loader animasi sederhana
    def spinner(text="Fetching balance..."):
        anim = ["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"]
        for i in range(20):
            sys.stdout.write(f"\r{text} {anim[i % len(anim)]}")
            sys.stdout.flush()
...
def get_family(
    ...
    # 🔄 Loader animasi sederhana
    def spinner(text="Fetching package family..."):
        anim = ["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"]
        for i in range(25):
            sys.stdout.write(f"\r{text} {anim[i % len(anim)]}")
            sys.stdout.flush()
    ...
    # 🔁 Ganti print awal dengan loader
    spinner("Fetching package family...")
...
def get_package(
    ...
    # 🔄 Loader animasi sederhana
    def spinner(text="Fetching package..."):
        anim = ["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"]
        for i in range(20):
            sys.stdout.write(f"\r{text} {anim[i % len(anim)]}")
            sys.stdout.flush()
    ...
    # 🔁 Ganti print biasa dengan loader
    spinner("Fetching package...")
...
def get_addons(api_key: str, tokens: dict, package_option_code: str) -> dict:
    ...
    # 🔄 Loader animasi sederhana
    def spinner(text="Fetching addons..."):
        anim = ["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"]
        for i in range(20):
            sys.stdout.write(f"\r{text} {anim[i % len(anim)]}")
            sys.stdout.flush()
...
def intercept_page(
    ...
    # 🔄 Loader animasi sederhana
    def spinner(text="Fetching intercept page..."):
        anim = ["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"]
        for i in range(20):
            sys.stdout.write(f"\r{text} {anim[i % len(anim)]}")
            sys.stdout.flush()
    ...
    # 🔁 Ganti print biasa dengan loader
    spinner("Fetching intercept page...")
    res = send_api_request(api_key, path, raw_payload, tokens["id_token"], "POST")
